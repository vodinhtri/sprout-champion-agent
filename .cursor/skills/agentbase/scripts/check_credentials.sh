...
#   bash .cursor/skills/agentbase/scripts/check_credentials.sh registry <path-to-credentials-file>
#   bash .cursor/skills/agentbase/scripts/check_credentials.sh registry --credentials-file <path>
#   bash .cursor/skills/agentbase/scripts/check_credentials.sh llm
#   bash .cursor/skills/agentbase/scripts/check_credentials.sh aip  # alias for llm
#
